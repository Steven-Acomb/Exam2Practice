...
def run_test_practice_problem2a():
    ...
    print('--------------------------------------------------')
    print(practice_problem2a([1,2,3],1))
    print([2,3,4])
    print()
    print(practice_problem2a([2, 3, 4], 2))
    print([3, 4, 5])
    print()
    print(practice_problem2a([1, 1, 1], 99))
    print([100, 100, 100])
    print()
    print(practice_problem2a([1, 2, 3], 101))
    print([102, 103, 104])
    print()
